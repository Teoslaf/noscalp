    ...
    <>
      ...
      <div className="screen-container min-h-screen">
        ...
        <div className="pt-top-bar-height pb-bottom-nav-height">
          {/* Tab Navigation */}
          <div className="px-screen-padding section-gap">
          ...
          {/* Tickets Grid */}
          <div className="px-screen-padding">
            {getFilteredTickets().length === 0 ? (
              ...
              <div className="grid grid-cols-2 gap-lg pb-xl">
                {getFilteredTickets().map((ticket) => (
                  <div
                    key={ticket.id}
                    onClick={() => handleTicketClick(ticket)}
                    className="card-primary cursor-pointer hover:scale-105 transition-transform duration-fast space-y-lg"
                  >
                    {/* NFT Image */}
                    <div className="relative">
                      <div className="aspect-square rounded-md overflow-hidden bg-bg-tertiary">
                        <img
                          src={ticket.nftImage}
                      ...
                      {/* Category Badge */}
                      <div className={`absolute top-sm right-sm ${getCategoryColor(ticket.category)} text-white px-sm py-xs rounded text-small`}>
                        NFT
                      </div>
          ...
          {userTickets.length > 0 && (
            <div className="px-screen-padding pb-xl">
